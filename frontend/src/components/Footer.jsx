  ...
  return (
    <footer className="bg-black py-20 border-t border-white/10 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-3xl font-bold text-white mb-6">Uni<span className="text-white/50">Roster</span></h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10">
          <p className="text-white/40 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} UniRoster Inc. All rights reserved.
          </p>
      ...
      <div className="absolute bottom-[-10vw] left-1/2 -translate-x-1/2 w-full flex justify-center opacity-5 pointer-events-none select-none">
        <span className="text-[20vw] font-black tracking-tighter whitespace-nowrap">UNIROSTER</span>
      </div>
    </footer>
  );
};
